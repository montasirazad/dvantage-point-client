...
const Prx2 = () => {
    return (
        <div className='p-3'>
            ...
            <div className='text-center'>
                <img src={prx2} alt="" className='col-lg-8' />
            </div>
