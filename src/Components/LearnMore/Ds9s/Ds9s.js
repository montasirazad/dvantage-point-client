    ...
    return (
        <div className='p-3'>
            ...
            <div className='text-center'>
                <img className='col-lg-8' style={{ boxShadow: 'rgba(3, 102, 214, 0.3) 0px 0px 0px 3px' }} src={ds9sCover} alt="" />
            </div>
            ...
            <div className='row my-5'>
                ...
                <div className='col-xs-8 col-sm-8 col-lg-8' style={{ textAlign: 'justify', textJustify: 'inter-word' }}>
                    <p>
                        <span className='text-primary display-4'><strong>U</strong></span>ptime or Service continuity is the core target or KPI
            ...
            <div className='text-center'>
                <img className='w-25' src={graph} alt="" />
            </div>
